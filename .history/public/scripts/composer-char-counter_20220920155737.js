...
$(document).ready(function () {
  ...
  */
  ...
  Can't use the same logic as the one in the keyup event as the length of val will always delayed,
  example, user press a, the val will still be empty,
  once the user press something else lets say a b, the val 
  */
