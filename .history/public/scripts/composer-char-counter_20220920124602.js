...
$(document).ready(function () {
  ...
  text-area by getting the length of its value. This is more accurate when user decides to delete a large amount 
  of characters all at once such as high-lighting and then pressing the delete or
  the backspace.
  */
  $("#tweet-text").on('keyup', () => {
